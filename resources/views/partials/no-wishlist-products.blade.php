...
<div class="max-w-2xl mx-auto">
	...
	<div
		...
		<h3 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">No Products in wishlist</h3>
		<p class="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Stay up to date for new updates</p>
