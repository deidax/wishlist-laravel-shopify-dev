...
<body>
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd;">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="/api/v1/customers">Customers</a>
            </li>
            <li class="nav-item">
    ...
    <h3>
        <span class="badge badge-primary mr-1">GET</span><span class="badge badge-secondary">/api/v1/customers</span>
    </h3>
...
var account = {!! json_encode($customers_data) !!};
